...
public class HttpUtil {
	...
	public static Bitmap getHttpBitmap(String url) {
		...
		try {
			...
			LogUtils.d("=============img byte============== :" + data.length);
	...
	static int code = 200;
	public static int getResponseCode(final Context context) {
		if (!PhoneUtil.isNetworkConnectedForLog(context)) {
			return -1;
		}
		new Thread(new Runnable() {
			...
			public void run() {
				try {
					...
					URL u = new URL("http://mos.tfschina.com.cn/tfsmo");
//					URL u = new URL("http://www.youtube.com");
					HttpURLConnection uConnection = (HttpURLConnection) u.openConnection();
					uConnection.connect();
					uConnection.setConnectTimeout(20000);
