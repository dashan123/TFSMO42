...
import cn.com.cloud9.asynctask.ViewPagerFragmentB64Photo;
import cn.com.cloud9.javabean.B64ListString;
import cn.com.cloud9.util.LogUtils;
import cn.com.cloud9.util.SDCardHelper;

public class B64PhotoActivity extends FragmentActivity {

	private ViewPager viewpager_b64_photo;
//	private ImageView img_b64_photo_back;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_viewpager_b64_photo);
	...
	public void getFragmentList() {
		...
		for (int i = 0; i < imgArrays.length; i++) {
			...
			ViewPagerFragmentB64Photo fragment = new ViewPagerFragmentB64Photo();
	...
	public void setCurrItem() {
		...
		for (int i = 0; i < imgArrays.length; i++) {
			if (i==index) {
				viewpager_b64_photo.setCurrentItem(i);
			}else {
				LogUtils.d("index!=i");
			}
		}
	...
	public void setAdapter() {
		...
		viewpager_b64_photo.setAdapter(pagerAdapter);
		viewpager_b64_photo.setVisibility(View.VISIBLE);
...
//	}
	...
	public void init() {
		...
		viewpager_b64_photo = (ViewPager) findViewById(R.id.viewpager_b64_photo);
//		img_b64_photo_back = (ImageView) findViewById(R.id.vp_b64_photo_back);
	...
	protected void onDestroy() {
		...
		viewpager_b64_photo = null;
//		img_b64_photo_back=null;
		totalUrlString=null;

		// 递归删除下载到本地的图片
		File dirFile = new File(SDCardHelper.getSDCardPath() + File.separator + "/workPicturePhoto/");
		if (dirFile.exists()) {
