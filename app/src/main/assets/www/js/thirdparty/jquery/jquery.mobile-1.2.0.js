...
(function( $, window ) {
	...
	$.widget( "mobile.loader", {
		...
		defaultHtml: "<div class='" + loaderClass + "' ></div>",
		...
		show: function( theme, msgText, textonly ) {
			...
			if ( $.mobile.loadingMessage !== false || loadSettings.html ) {
				...
				this.element.attr("style","background:none;border:none;width:200px");
//				this.element.attr("style","background:#ECEBEB;border:2px solid gray;width:200px");
				//this.element.attr("style","top:98px;bottom:-100px;left:100px;right:0px;background:#525252;width:100%;height:100%;");
		...
		alert: function(theme, msgText, textonly){
			var textVisible, message, $header, loadSettings;
			...
			if ( $.mobile.loadingMessage !== false || loadSettings.html ) {
				...
				// if the html attribute is defined on the loading settings, use that
				// otherwise use the fallbacks from above
//				this.element.attr("style","border:2px solid gray;background:#F2F2F2;width:200px;text-align:center;");
//				this.element.attr("style","border:none;background:#F2F2F2;width:200px;text-align:center");
				this.element.attr("style","opacity:1;border:1px solid lightgray;-moz-border-radius: 10px;-webkit-border-radius: 10px;border-radius:10px;background:#F2F2F2;width:230px;text-align:center");
//				var alertHtml = "<div id='alertDiv' style='font-size:15px'>"+loadSettings.html+"</div>";
				var alertHtml = "<div id='alertDiv' style='font-size:18px'>"+loadSettings.html+"</div>";
